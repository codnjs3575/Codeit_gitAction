      ...
      <form className="mx-auto max-w-md">
        <div className="relative z-0 mb-5 w-full">
          ...
          <label
            ...
            className="peer-placeholder-shown absolute top-3 origin-[0] -translate-y-6 scale-75 transform text-sm text-gray-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:font-medium peer-focus:text-blue-600 dark:text-gray-400 dark:peer-focus:text-blue-500"
          >
            이메일 주소
          </label>
        </div>
